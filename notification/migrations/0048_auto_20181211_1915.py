# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-12-11 08:15
...
def create_pod_templates(apps, schema_editor):
    ...
    def templates_generator():
        template_type = MessageTemplateStatus.POD_REPORT
...
def delete_pod_templates(apps, schema_editor):
    MerchantMessageTemplate = apps.get_model('notification', 'MerchantMessageTemplate')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notification', '0047_auto_20181211_1914'),
    ]

    operations = [
        migrations.RunPython(create_pod_templates, reverse_code=delete_pod_templates)
    ]
