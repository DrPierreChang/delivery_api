...
class DriverDriverInvitationTestCase(APITestCase):
    ...
    def create_pin_code(self):
        ...
        resp = self.client.post('/api/mobile/invitations/v1/getcode/', {'phone': self.invite_user_info['phone']})
        return resp

    def create_pin_code_for_android(self):
        self.create_default_invite()
        resp = self.client.post(
            '/api/mobile/invitations/v1/getcode/',
            {
    ...
    def send_validation(self):
        ...
        resp = self.client.post('/api/mobile/invitations/v1/validatecode/', {'phone': phone, 'pin_code': pin})
        return resp
    ...
    def send_password(self, password):
        ...
        resp = self.client.post('/api/mobile/invitations/v1/password/', {
            'phone': phone,
            'pin_code': pin,
            'password': password
        })
    ...
    def test_send_pin_without_prior_invitation(self):
        ...
        resp = self.client.post('/api/mobile/invitations/v1/getcode/', {'email': 'any_email@gm.co'})
        self.assertEqual(resp.status_code, status.HTTP_400_BAD_REQUEST)
