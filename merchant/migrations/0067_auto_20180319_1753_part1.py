    ...
    operations = [
        migrations.AddField(
            ...
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(
                choices=[('AF', 'Afghanistan'), ('AX', 'Ã\x85land Islands'), ('AL', 'Albania'),
                         ('DZ', 'Algeria'), ('AD', 'Andorra'), ('AO', 'Angola'), ('AI', 'Anguilla'),
                         ...
                         ('CV', 'Cape Verde'), ('BQ', 'Caribbean NL'), ('KY', 'Cayman Islands'),
                         ('CF', 'Central African Rep.'), ('TD', 'Chad'), ('CL', 'Chile'),
                         ('CN', 'China'), ('CX', 'Christmas Island'),
                         ('CC', 'Cocos (Keeling) Islands'), ('CO', 'Colombia'), ('KM', 'Comoros'),
                         ('CD', 'Congo (Dem. Rep.)'), ('CG', 'Congo (Rep.)'),
                         ('CK', 'Cook Islands'), ('CR', 'Costa Rica'), ('HR', 'Croatia'),
                         ('CU', 'Cuba'), ('CW', 'CuraÃ§ao'), ('CY', 'Cyprus'),
                         ('CZ', 'Czech Republic'), ('CI', "CÃ´te d'Ivoire"), ('DK', 'Denmark'),
                         ...
                         ('TF', 'French Southern & Antarctic Lands'), ('GA', 'Gabon'),
                         ...
                         ('HM', 'Heard Island & McDonald Islands'), ('HN', 'Honduras'),
                         ...
                         ('RO', 'Romania'), ('RU', 'Russia'), ('RW', 'Rwanda'), ('RE', 'RÃ©union'),
                         ('AS', 'Samoa (American)'), ('WS', 'Samoa (western)'),
                         ...
                         ('BL', 'St Barthelemy'), ('SH', 'St Helena'), ('KN', 'St Kitts & Nevis'),
                         ('LC', 'St Lucia'), ('SX', 'St Maarten (Dutch)'),
                         ('MF', 'St Martin (French)'), ('PM', 'St Pierre & Miquelon'),
                         ('VC', 'St Vincent'), ('SD', 'Sudan'), ('SR', 'Suriname'),
                         ('SJ', 'Svalbard & Jan Mayen'), ('SZ', 'Swaziland'), ('SE', 'Sweden'),
                         ...
                         ('TM', 'Turkmenistan'), ('TC', 'Turks & Caicos Is'), ('TV', 'Tuvalu'),
                         ('UM', 'US minor outlying islands'), ('US', 'USA'), ('UG', 'Uganda'),
                         ('UA', 'Ukraine'), ('AE', 'United Arab Emirates'),
                         ('GB', 'United Kingdom'), ('UY', 'Uruguay'), ('UZ', 'Uzbekistan'),
                         ('VU', 'Vanuatu'), ('VA', 'Vatican City'), ('VE', 'Venezuela'),
                         ('VN', 'Vietnam'), ('VG', 'Virgin Islands (UK)'),
                         ('VI', 'Virgin Islands (US)'), ('WF', 'Wallis & Futuna'),
                         ('EH', 'Western Sahara'), ('YE', 'Yemen'), ('ZM', 'Zambia'),
                         ('ZW', 'Zimbabwe')], default='AU', max_length=20),
                                                            default=merchant.models.merchant.default_merchant_countries,
                                                            size=None),
        ),
    ]
